...
<body>
  ...
  <section class="section2">
    <div class="container">
      <div class="row mx-auto justify-content-center">
        <div class="col-6 col-sm-4 col-md-3 col-lg-2 my-2" data-sal="slide-down" data-sal-delay="1000" data-sal-duration="500" data-sal-easing="ease-out-back">
    ...
    <div class="container">
      ...
      <div class="row col-12 justify-content-center">
        <form id="formContactUs" method="post" class="col-12 col-md-6">
          ...
          <div class="form-group col-12">
            <textarea type="text" name="message" class="form-control" placeholder="Leave us a message" required></textarea>
          </div>
          <div class="form-group col-12">
  ...
  <section class="section8 py-3 bg-dark text-light">
    <div class="row py-5 justify-content-center">
      <form id="formSubscribe" method="post" class="col-12 col-md-6">
        ...
        <div class="form-group col-12">
          ...
          <button type="submit" class="btn btn-sm btn-start mt-3">Submit</button>
        </div>
      </form>
    </div>
